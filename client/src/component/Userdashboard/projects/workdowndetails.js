...
function Workdowndetails() {
 ...
 const handleAddTask = () => {
  ...
  <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
      ...
      <div class="relative">
        <select id="type" name="type"   class="appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" >
